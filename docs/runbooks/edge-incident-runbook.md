...
- **CORS**: `curl -si -X OPTIONS https://localhost:8443/api/v1/users/health -H "Origin: https://evil.example" -H "Access-Control-Request-Method: GET" | grep access-control-allow-origin` (không được phép có output).
